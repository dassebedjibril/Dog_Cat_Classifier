...
from dataset import Cat_Dog_loader
from model import CNN_two
from model import CNN_four
...
train_dataset = Cat_Dog_loader(train_dir, transform=train_transform)
test_dataset = Cat_Dog_loader(test_dir, transform=test_transforms)
...
# Training settings for first model
n_features = 6 # hyperparameter

model_cnn1 = CNN_two(input_size, n_features, output_size)
...
# Training settings for 2nd model
n_features = 10 # hyperparameter
model_cnn2 = CNN_four(input_size, n_features, output_size)
